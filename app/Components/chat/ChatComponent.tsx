					...
					return (
						<Container
							...
							<Stack
								...
								gap={1}
								sx={{
									marginLeft: message.sentBy === "Radheshyam Jha" ? "auto" : 0,
									marginRight: message.sentBy === "Radheshyam Jha" ? 0 : "auto",
									maxWidth: "60%",
									alignItems: "start",
									paddingRight: 0,
								}}>
								{message.sentBy !== "Radheshyam Jha" && (
									<Avatar sizes="sm" src={undefined} />
								)}
								<Box
									sx={{
										bgcolor:
