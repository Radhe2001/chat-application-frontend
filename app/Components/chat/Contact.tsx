			...
			<AppBar
				...
				<Toolbar>
					...
					<Stack direction={"row"} marginLeft={"auto"} gap={0.5}>
						<IconButton
							sx={{
								bgcolor: themeMode === "light" ? "#FFDBDB" : "#222831",
								color: themeMode !== "light" ? "#FFDBDB" : "#3D365C",
								"&:hover": {
									backgroundColor:
										themeMode !== "light" ? "#FFDBDB" : "#3D365C",
									color: themeMode === "light" ? "#FFDBDB" : "#3D365C",
								},
							}}
							size="medium"
								...
								<ButtonBase
									...
									<Paper
										sx={{
											...
											padding: 1,
											"&:hover": {
												bgcolor: themeMode === "dark" ? "#420516" : "#FFDBDB",
											},
										}}
										key={contact.id}
										elevation={3}>
										<Stack
											...
											<Stack sx={{ textAlign: "start" }}>
												<Typography variant="body2" letterSpacing={0.7}>
													{contact.name}
												</Typography>
												<Typography
													variant="subtitle2"
