...
import RegisterAction from "@/app/Action/AuthActions/RegisterAction";
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Container sx={{ display: "flex", placeContent: "center" }}>
                    {registered ? (
                        <Stack>
                            <Typography
                                variant="h6"
                                ...
                                marginTop={4}
                            >
                                Verification mail has been send to your
                                registered e-mail account. <br />
                                Kindly verify it for successfull user
                                registration.
                            </Typography>
                            <Button
                                variant="contained"
                ...
                <Collapse in={warning.open} sx={{ marginTop: 4 }}>
